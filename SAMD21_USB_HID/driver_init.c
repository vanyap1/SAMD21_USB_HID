...
void RF_SPI_PORT_init(void)
{
	...
	gpio_set_pin_function(RLD, PINMUX_PA00D_SERCOM1_PAD0);
...
void system_init(void)
{
	...
	// Set pin direction to output
	gpio_set_pin_direction(SD_ACT, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(SD_ACT, GPIO_PIN_FUNCTION_OFF);
